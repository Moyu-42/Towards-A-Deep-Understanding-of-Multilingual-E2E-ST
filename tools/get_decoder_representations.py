...
def _main(cfg: DictConfig, output_file):
    ...
    for sample in progress:
        ...
        for idx in range(len(hypos)):
            ...
            for i in range(len(all_hidden_states)):
                res["layer_" + str(i)] = hypos[idx][0]['sentence_token_reps']["layer_" + str(i)].cpu().numpy()
                res["layer_" + str(i)] = np.mean(res["layer_" + str(i)], axis=0)
            for i in range(len(all_hidden_states)):
                if all_hidden_states["layer_" + str(i)] is None:
                    all_hidden_states["layer_" + str(i)] = res["layer_" + str(i)]
                else:
                    all_hidden_states["layer_" + str(i)] = np.concatenate(
                        (all_hidden_states["layer_" + str(i)], res["layer_" + str(i)]), axis=0
                    )
    ...
    for i in range(len(all_hidden_states)):
        ...
        all_hidden_states["layer_" + str(i)] = all_hidden_states["layer_" + str(i)][:3000]
        np.save(cfg.task.data + "/test" + "/" + cfg.task.language + "_layer_" + str(i) + '.npy', all_hidden_states["layer_" + str(i)])
